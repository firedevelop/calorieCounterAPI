    ...
    <>
      ...
      <footer className="bg-gray-800 text-gray-200 text-center py-6 mt-10 text-sm">
        <div className="flex justify-center items-center gap-2">
          ...
          <a href="https://github.com/firedevelop/calorieCounterAPI" target="_blank" rel="noopener noreferrer" title="GitHub Repository" className="text-white hover:text-orange-400 flex items-center gap-1">
